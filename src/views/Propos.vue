<template>
  <div class="propos">
    ...
    <div class="propos__box">
      <h2>À Propos</h2>
      <div class="propos__box__text">
        <p>
          Je suis un jeune développeur web situé sur Orléans dans le Loiret(45), je suis passionné d'informatique depuis mon enfance
